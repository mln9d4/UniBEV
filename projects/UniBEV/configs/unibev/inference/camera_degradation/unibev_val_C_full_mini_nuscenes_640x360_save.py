...
outdir = 'outputs/inference/showcasing_worsened_prediction/camera_degradation/unibev_val_C_full_mini_nuscenes_640x360'
keys = ['fused_bev_embed', 'img_mlvl_feats', 'img_bev_embed']
special_keys = []
attrs = []
