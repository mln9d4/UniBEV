...
# val_ann_file = sub_dir + 'nuscenes_annotation_files_custom/one_sample_mini_nuscenes_infos_temporal_val.pkl' # using the same val set but with customized annotation file that has more samples for better evaluation during training
...
featuremapping_checkpoint = '/home/mingdayang/mmdetection3d/outputs/train/25-02-2026-01_UNetAttention_mini_nuscenes_infos_temporal_train_mini_nuscenes_infos_temporal_val_BASELINE_BASELINE_BASELINE_DONT_DELETE/model_only.pth'
