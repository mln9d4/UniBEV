...
_base_ = ['unibev_nus_LC_cnw_256_modality_dropout_freeze_unibev_train_auxiliary_unetfeaturemapping4layers.py']
...
work_dir = './outputs/train/2026121302_unibev_lc_256_moddrop_freeze_FlexibleUNetNoSkip_quarternus'
    ...
    hooks=[
        ...
        dict(type='CustomWandbLoggerHook',
            ...
            init_kwargs=dict(
                ...
                notes='Training UniBEV with FlexibleUNetNoSkip, quarter nuscenes, freeze unibev weights, l1 loss',
                name='FlexibleUNetNoSkip_quarter_nuscenes_freezeunibev_auxiliaryloss',
                tags=[],
                allow_val_change=True,
                save_code=True,
                config=dict(
                    model='unet_feature_mapping_4layers',
                    work_dir=work_dir,
                    total_epochs=max_epochs,
