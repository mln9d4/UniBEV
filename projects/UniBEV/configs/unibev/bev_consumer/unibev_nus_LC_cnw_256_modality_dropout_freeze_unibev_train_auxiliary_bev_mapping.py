...
work_dir = './outputs/train/unibev_nus_LC_cnw_256_modality_dropout_freeze_unibev_train_auxiliary_bev_mapping'
...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        disable_detection=True, # disable the detection head during training and will stop other losses to be produced Mings code
        bev_h=bev_h_,
        bev_w=bev_w_,
        num_query=900,
        num_classes=10,
